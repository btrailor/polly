...
## 📌 OpenSpec-driven project tracking

**Authoritative sources (use these first):**
- **[openspec/specs/project/status.md](openspec/specs/project/status.md)** — Current status (single source of truth)
- **[openspec/specs/project/roadmap.md](openspec/specs/project/roadmap.md)** — Roadmap (tiers and phases)
- **[openspec/INDEX.md](openspec/INDEX.md)** — OpenSpec index and workflow

**Reference and history:**
- **[docs/status/CURRENT.md](docs/status/CURRENT.md)** — Detailed status reference
- **[docs/status/CHANGELOG.md](docs/status/CHANGELOG.md)** — Completion history
- **[docs/planning/README.md](docs/planning/README.md)** — Planning navigator
- **[docs/planning/tiers/](docs/planning/tiers/)** — Tier docs
- **[docs/planning/phases/](docs/planning/phases/)** — Phase specifications

This document is the full roadmap and vision (reference). For day-to-day status and next steps, use the OpenSpec project specs above.
...
5. **Spec-driven changes** - Use [OpenSpec](https://github.com/Fission-AI/OpenSpec) for new features: [openspec/README.md](openspec/README.md)
6. **Test incrementally** - Verify each phase works before moving to the next
