...
### Phase 12b-Extended: Quality Controls (2–3 weeks)
- Isolated note flagging + inbox
- Merge/delete batch operations
- Authority scoring integrated into RAG retrieval (RRF weighting)
- Garden maintenance prompts (weekly digest)
- Entity-graph traversal as third RAG retrieval strategy
